...
function _5(yCounts,cal,data)
{
  yCounts.length = 0; //將yCounts清空

  for (var y=0; y<12; y++) { 
    //所有年份都建立兩個Object，一個存放男性資料，一個存放女性資料
    yCounts.push({Constellation:cal[y], gender:"男", count:0});
    //Object包含：1. 星座代號，2.男性，3.人數(設為0)
    yCounts.push({Constellation:cal[y], gender:"女", count:0}); 
    // Object包含：1. 星座代號，2.女性，3.人數(設為0)
  }
  data.forEach (x=> {
...
function _7(Plot,plot2,yCounts){return(
Plot.plot({
...
function _9(Plot,plot1,cal,data){return(
Plot.plot({  
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("cal")).define("cal", _cal);
  main.variable(observer("yCounts")).define("yCounts", _yCounts);
  main.variable(observer()).define(["yCounts","cal","data"], _5);
  ...
  main.variable(observer()).define(["Plot","plot2","yCounts"], _7);
  ...
  main.variable(observer()).define(["Plot","plot1","cal","data"], _9);
  return main;
}
