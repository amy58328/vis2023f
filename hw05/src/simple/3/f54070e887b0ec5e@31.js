...
function _simple1(FileAttachment){return(
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["simple.json", {url: new URL("../../output.json", import.meta.url), mimeType: "application/json", toString}],
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("simple")).define("simple", ["d3","simple_data","drag","invalidation"], _simple);
  main.variable(observer("simple1")).define("simple1", ["FileAttachment"], _simple1);
